...
<div class="container">
    <div class="row justify-content-center text-right">
        <div class="col-md-8">
            <div class="card my-5">
                <div class="card-header">ثبت نام کاربر عادی</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">ایمیل(نام کاربری)</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right">تصویر پروفایل</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row mb-0 dir-left">
